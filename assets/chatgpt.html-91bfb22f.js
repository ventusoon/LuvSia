...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><ul><li>然後就可以通過 IP:3002 來訪問 <em>ChatGPT</em></li></ul><h3 id="三、反向代理-chatgpt-並使用打字機效果" tabindex="-1"><a class="header-anchor" href="#三、反向代理-chatgpt-並使用打字機效果" aria-hidden="true">#</a> 三、反向代理 <em>ChatGPT</em> 並使用打字機效果</h3>`,18),z={href:"http://chat.example.com",target:"_blank",rel:"noopener noreferrer"},L=i('<figure><img src="'+l+'" alt="ChatGPT" tabindex="0" loading="lazy"><figcaption>ChatGPT</figcaption></figure><ul><li>反向代理</li></ul><figure><img src="'+t+`" alt="ChatGPT" tabindex="0" loading="lazy"><figcaption>ChatGPT</figcaption></figure><ul><li>修改反向代理配置文件，實現打字機效果</li></ul><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token comment">#設置反向代理參數以支持流式輸出</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><figure><img src="`+o+'" alt="ChatGPT" tabindex="0" loading="lazy"><figcaption>ChatGPT</figcaption></figure><h1 id="大功告成-enjoy" tabindex="-1"><a class="header-anchor" href="#大功告成-enjoy" aria-hidden="true">#</a> 大功告成，<em>Enjoy</em></h1>',7);function V(X,D){const a=d("ExternalLinkIcon");return r(),p("div",null,[h,n("ul",null,[n("li",null,[n("p",null,[n("a",v,[b,s(a)]),e("（全名："),_,e("），是美国OpenAI研发的聊天机器人程序，于2022年11月30日发布。")])]),k]),u(" more "),n("h1",g,[f,e(),n("a",P,[T,s(a)])]),C,n("ol",null,[n("li",null,[n("a",x,[A,s(a)]),e(" 使用 "),I,e(" 通過官方 "),E,e(" 補全 "),O,e(" 模擬 "),G,e(" （最穩健的方法，但它不是免費的，並且沒有使用針對聊天進行微調的模型）")]),n("li",null,[n("a",S,[y,s(a)]),e(" 使用非官方代理服務器訪問 "),N,e(" 的後端 "),R,e("，繞過 "),Y,e("（使用真實的的 "),K,e("，非常輕量級，但依賴於第三方服務器，並且有速率限制）")])]),w,n("ul",null,[n("li",null,[e("在寶塔面板中新建網站 "),n("a",z,[e("chat.example.com"),s(a)]),e(" 並註冊證書、啟用HTTPS")])]),L])}const j=c(m,[["render",V],["__file","chatgpt.html.vue"]]);export{j as default};
