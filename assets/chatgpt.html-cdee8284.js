...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><figure><img src="`+o+'" alt="ChatGPT" tabindex="0" loading="lazy"><figcaption>ChatGPT</figcaption></figure><h2 id="大功告成-enjoy" tabindex="-1"><a class="header-anchor" href="#大功告成-enjoy" aria-hidden="true">#</a> 大功告成，<em>Enjoy</em></h2>',26);function L(V,X){const a=d("ExternalLinkIcon");return r(),p("div",null,[h,n("ul",null,[n("li",null,[n("p",null,[n("a",v,[b,s(a)]),e("（全名："),_,e("），美国OpenAI研发的聊天机器人程序，于2022年11月30日发布。")])]),k]),u(" more "),n("h2",g,[f,e(),n("a",P,[T,s(a)])]),C,n("ol",null,[n("li",null,[n("a",x,[A,s(a)]),e(" 使用 "),I,e(" 通过官方 "),E,e(" 补全 "),O,e(" 模拟 "),G,e(" （最稳健的方法，但它不是免费的，并且没有使用针对聊天进行微调的模型）")]),n("li",null,[n("a",S,[y,s(a)]),e(" 使用非官方代理服务器访问 "),N,e(" 的后端 "),R,e("，绕过 "),Y,e("（使用真实的的 "),K,e("，非常轻量级，但依赖于第三方服务器，并且有速率限制）")])]),w])}const B=c(m,[["render",L],["__file","chatgpt.html.vue"]]);export{B as default};
