...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><ul><li>然后就可以通过 IP:3002 来访问 <em>ChatGPT</em></li></ul><h3 id="三、反代-chatgpt-并使用打字机效果" tabindex="-1"><a class="header-anchor" href="#三、反代-chatgpt-并使用打字机效果" aria-hidden="true">#</a> 三、反代 <em>ChatGPT</em> 并使用打字机效果</h3><ul><li>宝塔面板中新建网站chat.example.com并注册证书、开启HTTPS</li></ul><figure><img src="`+d+'" alt="ChatGPT" tabindex="0" loading="lazy"><figcaption>ChatGPT</figcaption></figure><ul><li>反向代理</li></ul><figure><img src="'+r+`" alt="ChatGPT" tabindex="0" loading="lazy"><figcaption>ChatGPT</figcaption></figure><ul><li>修改反向代理配置文件，实现打字机效果</li></ul><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token comment">#设置反向代理参数以支持流式输出</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><figure><img src="`+p+'" alt="ChatGPT" tabindex="0" loading="lazy"><figcaption>ChatGPT</figcaption></figure><h1 id="大功告成-enjoy" tabindex="-1"><a class="header-anchor" href="#大功告成-enjoy" aria-hidden="true">#</a> 大功告成，<em>Enjoy</em></h1>',26);function K(z,L){const a=t("ExternalLinkIcon");return c(),o("div",null,[m,n("ul",null,[n("li",null,[n("p",null,[n("a",h,[v,s(a)]),e("（全名："),b,e("），美国OpenAI研发的聊天机器人程序，于2022年11月30日发布。")])]),_]),n("h1",k,[g,e(),n("a",f,[P,s(a)])]),T,n("ol",null,[n("li",null,[n("a",C,[x,s(a)]),e(" 使用 "),A,e(" 通过官方 "),I,e(" 补全 "),G,e(" 模拟 "),O,e(" （最稳健的方法，但它不是免费的，并且没有使用针对聊天进行微调的模型）")]),n("li",null,[n("a",E,[S,s(a)]),e(" 使用非官方代理服务器访问 "),y,e(" 的后端 "),N,e("，绕过 "),R,e("（使用真实的的 "),Y,e("，非常轻量级，但依赖于第三方服务器，并且有速率限制）")])]),w])}const D=l(u,[["render",K],["__file","chatgpt.html.vue"]]);export{D as default};
