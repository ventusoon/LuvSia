import{_ as i,a as t,b as o}from"./3-47e785b4.js";import{_ as c}from"./plugin-vue_export-helper-c27b6911.js";import{r as d,o as r,c as p,a as n,e as s,b as e,d as u,f as l}from"./app-41d59a7d.js";const m={},h=n("blockquote",null,[n("p",null,[n("em",null,[n("strong",null,"3 Steps Build Your Own ChatGPT Web")])])],-1),v={href:"https://baike.baidu.com/item/ChatGPT/62446358?fr=aladdin",target:"_blank",rel:"noopener noreferrer"},b=n("em",null,"ChatGPT",-1),_=n("em",null,"Chat Generative Pre-trained Transformer",-1),k=n("li",null,[n("p",null,"ChatGPT是人工智能技术驱动的自然语言处理工具，它能够通过理解和学习人类的语言来进行对话，还能根据聊天的上下文进行互动，真正像人类一样来聊天交流，甚至能完成撰写邮件、视频脚本、文案、翻译、代码，写论文等任务。")],-1),g={id:"chatgpt-web",tabindex:"-1"},f=n("a",{class:"header-anchor",href:"#chatgpt-web","aria-hidden":"true"},"#",-1),P={href:"https://github.com/ventusoon/chatgpt-web",target:"_blank",rel:"noopener noreferrer"},T=n("em",null,"ChatGPT-Web",-1),C=l('<ul><li>支持双模型，提供了两种非官方 <code>ChatGPT API</code> 方法</li></ul><h3 id="介绍" tabindex="-1"><a class="header-anchor" href="#介绍" aria-hidden="true">#</a> 介绍</h3><table><thead><tr><th>方式</th><th>免费？</th><th>可靠性</th><th>质量</th></tr></thead><tbody><tr><td><code>ChatGPTAPI(gpt-3.5-turbo-0301)</code></td><td>否</td><td>可靠</td><td>相对较笨</td></tr><tr><td><code>ChatGPTUnofficialProxyAPI(网页 accessToken)</code></td><td>是</td><td>相对不可靠</td><td>聪明</td></tr></tbody></table><ul><li>对比：</li></ul>',4),x={href:"https://platform.openai.com/",title:"API获取",target:"_blank",rel:"noopener noreferrer"},A=n("em",null,"ChatGPTAPI(gpt-3.5-turbo-0301)",-1),I=n("em",null,"gpt-3.5-turbo-0301",-1),O=n("em",null,"OpenAI",-1),E=n("em",null,"API",-1),G=n("em",null,"ChatGPT",-1),S={href:"https://chat.openai.com/api/auth/session",title:"AccessToken获取",target:"_blank",rel:"noopener noreferrer"},y=n("em",null,"ChatGPTUnofficialProxyAPI",-1),N=n("em",null,"ChatGPT",-1),R=n("em",null,"API",-1),Y=n("em",null,"Cloudflare",-1),w=n("em",null,"ChatGPT",-1),K=l(`<ul><li>感谢原作者<em>Chanzhaoyu</em>的辛苦付出</li></ul><h2 id="搭建步骤" tabindex="-1"><a class="header-anchor" href="#搭建步骤" aria-hidden="true">#</a> 搭建步骤</h2><h3 id="一、安装-docker-及-docker-compose" tabindex="-1"><a class="header-anchor" href="#一、安装-docker-及-docker-compose" aria-hidden="true">#</a> 一、安装 <em>Docker</em> 及 <em>Docker-compose</em></h3><ul><li>安装 <em>Docker</em></li></ul><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token comment">#更新、安装必备软件</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><ul><li>然后就可以通过 IP:3002 来访问 <em>ChatGPT</em></li></ul><h3 id="三、反代-chatgpt-并使用打字机效果" tabindex="-1"><a class="header-anchor" href="#三、反代-chatgpt-并使用打字机效果" aria-hidden="true">#</a> 三、反代 <em>ChatGPT</em> 并使用打字机效果</h3><ul><li>宝塔面板中新建网站chat.example.com并注册证书、开启HTTPS</li></ul><figure><img src="`+i+'" alt="ChatGPT" tabindex="0" loading="lazy"><figcaption>ChatGPT</figcaption></figure><ul><li>反向代理</li></ul><figure><img src="'+t+`" alt="ChatGPT" tabindex="0" loading="lazy"><figcaption>ChatGPT</figcaption></figure><ul><li>修改反向代理配置文件，实现打字机效果</li></ul><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token comment">#设置反向代理参数以支持流式输出</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><figure><img src="`+o+'" alt="ChatGPT" tabindex="0" loading="lazy"><figcaption>ChatGPT</figcaption></figure><h2 id="大功告成-enjoy" tabindex="-1"><a class="header-anchor" href="#大功告成-enjoy" aria-hidden="true">#</a> 大功告成，<em>Enjoy</em></h2>',26);function L(V,X){const a=d("ExternalLinkIcon");return r(),p("div",null,[h,n("ul",null,[n("li",null,[n("p",null,[n("a",v,[b,s(a)]),e("（全名："),_,e("），美国OpenAI研发的聊天机器人程序，于2022年11月30日发布。")])]),k]),u(" more "),n("h2",g,[f,e(),n("a",P,[T,s(a)])]),C,n("ol",null,[n("li",null,[n("a",x,[A,s(a)]),e(" 使用 "),I,e(" 通过官方 "),O,e(" 补全 "),E,e(" 模拟 "),G,e(" （最稳健的方法，但它不是免费的，并且没有使用针对聊天进行微调的模型）")]),n("li",null,[n("a",S,[y,s(a)]),e(" 使用非官方代理服务器访问 "),N,e(" 的后端 "),R,e("，绕过 "),Y,e("（使用真实的的 "),w,e("，非常轻量级，但依赖于第三方服务器，并且有速率限制）")])]),K])}const z=c(m,[["render",L],["__file","chatgpt.html.vue"]]);export{z as default};
